...
public class EmployerManager implements EmployerService {
	...
	public Result save(Employer employer) {
		if (mailCheckservice.confirm(employer) &&service.confirm(employer)&& validatör.employerValidatör(employer,employerDao).isSuccess()) {
			...
			System.out.println(validatör.employerValidatör(employer, employerDao).isSuccess());
